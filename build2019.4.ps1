...
try
{
    ...
    GetPackage intelmkl.redist.win-x64 2019.4.245
    ...
    GetPackage intelmkl.redist.win-x86 2019.4.245
    ...
    GetPackage intelopenmp.redist.win 2019.4.245
    ...
    GetPackage inteltbb.redist.win 2019.4.235
    ...
    GetPackage intelmkl.devel.linux-x64 2019.4.243
    ...
    GetPackage intelmkl.devel.linux-x86 2019.4.243
    ...
    GetPackage intelopenmp.devel.linux 2019.4.243
    ...
    GetPackage inteltbb.devel.linux 2019.4.231
    ...
    GetPackage intelmkl.devel.osx-x64 2019.4.233
    ...
    GetPackage intelopenmp.devel.osx 2019.4.233
    ...
    GetPackage inteltbb.devel.osx 2019.4.230
    ...
    dotnet pack MKL.NET.win-x64 -o packages -p:Version=2019.4.245
    dotnet pack MKL.NET.win-x86 -o packages -p:Version=2019.4.245
    dotnet pack MKL.NET.linux-x64 -o packages -p:Version=2019.4.243
    dotnet pack MKL.NET.linux-x86 -o packages -p:Version=2019.4.243
    dotnet pack MKL.NET.osx-x64 -o packages -p:Version=2019.4.233
}
