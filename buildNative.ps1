...
try
{
    ...
    GetPackage intelmkl.redist.win-x64 2020.4.311
    ...
    GetPackage intelmkl.redist.win-x86 2020.4.311
    ...
    GetPackage intelopenmp.redist.win 2020.4.311
    ...
    GetPackage inteltbb.redist.win 2020.3.311
    ...
    GetPackage intelmkl.devel.linux-x86 2020.4.304
    ...
    GetPackage intelopenmp.devel.linux 2020.3.304
    ...
    GetPackage inteltbb.devel.linux 2020.3.304
    ...
    GetPackage intelmkl.devel.osx-x64 2020.4.301
    ...
    GetPackage intelopenmp.devel.osx 2020.3.301
    ...
    GetPackage inteltbb.devel.osx 2020.3.301
    ...
    dotnet pack MKL.NET.win-x64 -o packages -p:Version=2020.4.311
    dotnet pack MKL.NET.win-x86 -o packages -p:Version=2020.4.311
    dotnet pack MKL.NET.linux-x64 -o packages -p:Version=2020.4.304
    dotnet pack MKL.NET.linux-x86 -o packages -p:Version=2020.4.304
    dotnet pack MKL.NET.osx-x64 -o packages -p:Version=2020.4.301
}
