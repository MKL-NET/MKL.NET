...
try
{
    ...
    GetPackage intelmkl.redist.win-x64 2020.0.166
    ...
    GetPackage intelmkl.redist.win-x86 2020.0.166
    ...
    GetPackage intelopenmp.redist.win 2020.0.166
    ...
    GetPackage inteltbb.redist.win 2020.0.166
    ...
    GetPackage intelmkl.devel.linux-x64 2020.0.166
    ...
    GetPackage intelmkl.devel.linux-x86 2020.0.166
    ...
    GetPackage intelopenmp.devel.linux 2020.0.166
    ...
    GetPackage inteltbb.devel.linux 2020.0.166
    ...
    GetPackage intelmkl.devel.osx-x64 2020.0.166
    ...
    GetPackage intelopenmp.devel.osx 2020.0.166
    ...
    GetPackage inteltbb.devel.osx 2020.0.166
    ...
    dotnet pack MKL.NET.win-x64 -o packages -p:Version=2020.0.166
    dotnet pack MKL.NET.win-x86 -o packages -p:Version=2020.0.166
    dotnet pack MKL.NET.linux-x64 -o packages -p:Version=2020.0.166
    dotnet pack MKL.NET.linux-x86 -o packages -p:Version=2020.0.166
    dotnet pack MKL.NET.osx-x64 -o packages -p:Version=2020.0.166
}
