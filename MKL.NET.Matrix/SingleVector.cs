...
namespace MKLNET.Single;

using System;
using MKLNET.Single.Expression;

public class vector : IDisposable
{
    public int Length;
    public float[] Array;
    public vector(int length, float[] reuse)
    {
        Length = length;
        Array = reuse;
    }
    ...
    public vector(int length, Func<int, float> init)
    {
        Length = length;
    ...
    public static VectorExpression operator +(vector a, float s) => new VectorAddScalar(a, s);
    public static VectorExpression operator +(float s, vector a) => new VectorAddScalar(a, s);
    public static VectorExpression operator -(vector a, float s) => new VectorAddScalar(a, -s);
    public static VectorExpression operator -(float s, vector a) => s - (VectorExpression)a;
    ...
    public static VectorExpression operator *(vector a, float s) => new VectorScale(a, s);
    public static VectorExpression operator *(float s, vector a) => new VectorScale(a, s);
    public static VectorExpression operator /(vector a, float s) => new VectorScale(a, 1 / s);
    public static float operator *(vectorT vt, vector v) => (VectorTExpression)vt * (VectorExpression)v;
    public static float operator *(VectorTExpression vt, vector v) => vt * (VectorExpression)v;
...
public class vectorT : IDisposable
{
    public int Length;
    public float[] Array;
    public vectorT(int length, float[] reuse)
    {
        Length = length;
        Array = reuse;
    }
    ...
    public vectorT(int length, Func<int, float> init)
    {
        Length = length;
        var a = matrix.Pool.Rent(length);
        for (int i = 0; i < length; i++)
    ...
    public static VectorTExpression operator +(vectorT a, float s) => new VectorTAddScalar(a, s);
    public static VectorTExpression operator +(float s, vectorT a) => new VectorTAddScalar(a, s);
    public static VectorTExpression operator -(vectorT a, float s) => new VectorTAddScalar(a, -s);
    public static VectorTExpression operator -(float s, vectorT a) => s - (VectorTExpression)a;
    ...
    public static VectorTExpression operator *(vectorT vt, float s) => new VectorTScale(vt, s);
    public static VectorTExpression operator *(float s, vectorT vt) => new VectorTScale(vt, s);
    public static VectorTExpression operator /(vectorT vt, float s) => new VectorTScale(vt, 1 / s);
    public static float operator *(vectorT vt, vector v) => vt * (VectorExpression)v;
    public static float operator *(vectorT vt, VectorExpression v) => (VectorTExpression)vt * v;
...
public static class Vector
{
    ...
    public static VectorExpression Powx(VectorExpression v, float b) => new MatrixToVector(new MatrixPowx(v.ToMatrix(), b));
    public static VectorTExpression Powx(VectorTExpression v, float b) => new MatrixToVectorT(new MatrixPowx(v.ToMatrix(), b));
    ...
    public static VectorExpression Max(VectorExpression a, float b) => new MatrixToVector(new MatrixMaxScalar(a.ToMatrix(), b));
    ...
    public static VectorExpression Min(VectorExpression a, float b) => new MatrixToVector(new MatrixMinScalar(a.ToMatrix(), b));
    ...
    public static VectorExpression LinearFrac(VectorExpression a, VectorExpression b, float scalea, float shifta, float scaleb, float shiftb)
        => new MatrixToVector(new MatrixLinearFrac(a.ToMatrix(), b.ToMatrix(), scalea, shifta, scaleb, shiftb));
    public static VectorTExpression LinearFrac(VectorTExpression a, VectorTExpression b, float scalea, float shifta, float scaleb, float shiftb)
        => new MatrixToVectorT(new MatrixLinearFrac(a.ToMatrix(), b.ToMatrix(), scalea, shifta, scaleb, shiftb));
    public static float Asum(VectorExpression a) => Matrix.Asum(a.ToMatrix());
    public static float Asum(VectorTExpression a) => Matrix.Asum(a.ToMatrix());
    public static float Nrm2(VectorExpression a) => Matrix.Nrm2(a.ToMatrix());
    public static float Nrm2(VectorTExpression a) => Matrix.Nrm2(a.ToMatrix());
