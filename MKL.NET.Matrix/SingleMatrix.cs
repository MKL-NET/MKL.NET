...
{
    internal static ArrayPool<float> Pool = new(1024 * 1024, 10);
    public readonly int Rows, Cols;
    public float[] Array;
    public int Length => Rows * Cols;
    public matrix(int rows, int cols, float[] reuse)
    {
        Rows = rows;
        Cols = cols;
        Array = reuse;
    ...
    public matrix(int rows, int cols, Func<int, int, float> init)
    {
        Rows = rows;
        Cols = cols;
    ...
    public static MatrixExpression operator +(matrix a, float s) => new MatrixAddScalar(a, s);
    public static MatrixExpression operator +(float s, matrix a) => new MatrixAddScalar(a, s);
    public static MatrixExpression operator -(matrix a, float s) => new MatrixAddScalar(a, -s);
    public static MatrixExpression operator -(float s, matrix a) => s - (MatrixExpression)a;
    ...
    public static MatrixExpression operator -(MatrixExpression a, matrix b) => a - (MatrixExpression)b;
    public static MatrixExpression operator -(matrix a, MatrixExpression b) => (MatrixExpression)a - b;
    public static MatrixExpression operator *(matrix a, float s) => new MatrixScale(a, s);
    public static MatrixExpression operator *(float s, matrix a) => new MatrixScale(a, s);
    public static MatrixExpression operator /(matrix a, float s) => new MatrixScale(a, 1 / s);
...
public static class Matrix
{
    ...
    public static MatrixExpression Powx(MatrixExpression m, float b) => new MatrixPowx(m, b);
    ...
    public static MatrixExpression Max(MatrixExpression a, float b) => new MatrixMaxScalar(a, b);
    public static MatrixExpression Min(MatrixExpression a, MatrixExpression b) => new MatrixFmin(a, b);
    public static MatrixExpression Min(MatrixExpression a, float b) => new MatrixMinScalar(a, b);
    ...
    public static MatrixExpression LinearFrac(MatrixExpression a, MatrixExpression b, float scalea, float shifta, float scaleb, float shiftb)
    ...
    public static float Asum(MatrixExpression a)
    {
        var i = a.Evaluate();
    ...
    public static float Nrm2(MatrixExpression a)
    {
        var i = a.Evaluate();
    ...
    public static float Det(MatrixExpression a)
    {
        var m = a.Evaluate();
    ...
    /// <param name="C"></param>
    public static void Symmetric_Rank_k_Update(float alpha, matrix A, float beta, matrix C)
    {
    ...
    /// <param name="beta"></param>
    /// <param name="C"></param>
    public static void Symmetric_Rank_k_Update(float alpha, vector A, float beta, matrix C)
    {
    ...
    /// <param name="beta"></param>
    /// <param name="C"></param>
    public static void Symmetric_Rank_2k_Update(float alpha, matrix A, matrix B, float beta, matrix C)
    {
    ...
    /// <param name="beta"></param>
    /// <param name="C"></param>
    public static void Symmetric_Rank_2k_Update(float alpha, vector A, vector B, float beta, matrix C)
    {
