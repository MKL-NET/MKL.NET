...
namespace MKLNET
{
    ...
    public static class Vector
    {
        ...
        public static VectorExpression Trunc(VectorExpression v) => new MatrixToVector(new MatrixTrunc(v.ToMatrix()));
        public static VectorTExpression Trunc(VectorTExpression v) => new MatrixToVectorT(new MatrixTrunc(v.ToMatrix()));
        public static VectorExpression Round(VectorExpression v) => new MatrixToVector(new MatrixRound(v.ToMatrix()));
        public static VectorTExpression Round(VectorTExpression v) => new MatrixToVectorT(new MatrixRound(v.ToMatrix()));
        ...
        public static VectorExpression Fmax(VectorExpression a, VectorExpression b) => new MatrixToVector(new MatrixFmax(a.ToMatrix(), b.ToMatrix()));
        public static VectorTExpression Fmax(VectorTExpression a, VectorExpression b) => new MatrixToVectorT(new MatrixFmax(a.ToMatrix(), b.ToMatrix()));
        public static VectorExpression Fmin(VectorExpression a, VectorExpression b) => new MatrixToVector(new MatrixFmin(a.ToMatrix(), b.ToMatrix()));
        public static VectorTExpression Fmin(VectorTExpression a, VectorExpression b) => new MatrixToVectorT(new MatrixFmin(a.ToMatrix(), b.ToMatrix()));
