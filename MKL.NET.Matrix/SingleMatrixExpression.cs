...
{
    public abstract Single.matrix Evaluate();
    public static implicit operator MatrixExpression(Single.matrix a) => new MatrixInput(a);
    public static implicit operator Single.matrix(MatrixExpression a) => a.Evaluate();
    public static MatrixExpression operator +(MatrixExpression a, float s) => new MatrixAddScalar(a, s);
    public static MatrixExpression operator +(float s, MatrixExpression b) => new MatrixAddScalar(b, s);
    public static MatrixExpression operator -(MatrixExpression a, float s) => new MatrixAddScalar(a, -s);
    public static MatrixExpression operator -(float s, MatrixExpression a) =>
        new MatrixAddScalar(a is MatrixScale sm ? new MatrixScale(sm.E, -sm.S) : new MatrixScale(a, -1.0f), s);
    ...
    public static MatrixExpression operator *(MatrixExpression a, float s) =>
    ...
    public static MatrixExpression operator *(float s, MatrixExpression a) =>
        ...
        : a is MatrixSubSimple mss ? new MatrixAdd(mss.Ea, false, s, mss.Eb, false, -s, null)
        : new MatrixScale(a, s);
    public static MatrixExpression operator /(MatrixExpression a, float s) => a * (1 / s);
    ...
    public MatrixExpression T =>
        ...
        : this is MatrixAddSimple mas ? new MatrixAdd(mas.Ea, true, 1.0f, mas.Eb, true, 1.0f, null)
        : this is MatrixSubSimple mss ? new MatrixAdd(mss.Ea, true, 1.0f, mss.Eb, true, -1.0f, null)
        : new MatrixTranspose(this);
    public static VectorExpression operator *(MatrixExpression m, Single.vector v) => new MatrixVectorMultiply(m, v, null);
    ...
    public static VectorTExpression operator *(Single.vectorT vt, MatrixExpression m) => new VectorTMatrixMultiply(vt, m, null);
}

public class MatrixInput : MatrixExpression
{
    readonly protected Single.matrix m;
    public MatrixInput(Single.matrix a) => m = a;
    public override Single.matrix Evaluate() => m;
}

public class MatrixReuse : MatrixExpression
{
    readonly protected Single.matrix m;
    public MatrixReuse(Single.matrix a) => m = a;
    public override Single.matrix Evaluate() => m;
}
...
public class MatrixScale : MatrixExpression
{
    ...
    public MatrixScale(MatrixExpression a, float s)
    {
        E = a;
        S = s;
    }
    public override Single.matrix Evaluate()
    {
        ...
        else
        {
            ...
            if (E is MatrixInput)
            {
                var r = new Single.matrix(a.Rows, a.Cols);
...
public class MatrixTranspose : MatrixExpression
{
    ...
    public override Single.matrix Evaluate()
    {
        ...
        {
            var r = new Single.matrix(a.Cols, a.Rows);
            Blas.omatcopy(LayoutChar.ColMajor, TransChar.Yes, a.Rows, a.Cols, 1.0f, a.Array, a.Rows, r.Array, r.Rows);
            return r;
        }
        else
        {
            var r = new Single.matrix(a.Cols, a.Rows, a.ReuseArray());
            Blas.imatcopy(LayoutChar.ColMajor, TransChar.Yes, a.Rows, a.Cols, 1.0f, a.Array, a.Rows, r.Rows);
            return r;
        }
    }
}
...
public abstract class MatrixUnary : MatrixExpression
{
    ...
    protected abstract void Evaluate(Single.matrix a, Single.matrix r);
    public override Single.matrix Evaluate()
    {
        var a = E.Evaluate();
        var r = E is MatrixInput ? new Single.matrix(a.Rows, a.Cols) : a;
        Evaluate(a, r);
        return r;
    }
}
...
public abstract class MatrixBinary : MatrixExpression
{
    ...
    protected abstract void Evaluate(Single.matrix a, Single.matrix b, Single.matrix r);
    public override Single.matrix Evaluate()
    {
        var a = Ea.Evaluate();
        var b = Eb.Evaluate();
...
public class MatrixAddSimple : MatrixExpression
{
    ...
    public MatrixAddSimple(MatrixExpression a, MatrixExpression b, float[]? reuse)
    {
        Ea = a;
        Eb = b;
        R = reuse;
    ...
    public override Single.matrix Evaluate()
    {
        ...
        var b = Eb.Evaluate();
        if (a.Rows != b.Rows || a.Cols != b.Cols) ThrowHelper.ThrowIncorrectDimensionsForOperation();
        var r = R is not null ? new Single.matrix(a.Rows, a.Cols, R)
...
public class MatrixSubSimple : MatrixExpression
{
    public readonly MatrixExpression Ea, Eb;
    public readonly float[]? R;
    public MatrixSubSimple(MatrixExpression a, MatrixExpression b, float[]? reuse)
    {
        Ea = a;
        Eb = b;
        R = reuse;
...
{
    public readonly MatrixExpression Ea, Eb;
    public readonly float Sa, Sb;
    public readonly bool Transa, Transb;
    public readonly float[]? R;
    public MatrixAdd(MatrixExpression a, bool transa, float sa, MatrixExpression b, bool transb, float sb, float[]? reuse)
    {
        Ea = a;
        Eb = b;
        Sa = sa;
    ...
    public override Single.matrix Evaluate()
    {
        ...
        var r = R is not null ? Transa ? new Single.matrix(a.Cols, a.Rows, R) : new Single.matrix(a.Rows, a.Cols, R)
              : Ea is not MatrixInput ? (Transa ? new Single.matrix(a.Cols, a.Rows, a.ReuseArray()) : a)
              : Eb is not MatrixInput ? (Transb ? new Single.matrix(b.Cols, b.Rows, b.ReuseArray()) : b)
...
public class MatrixAddScalar : MatrixExpression
{
    public readonly MatrixExpression E;
    public readonly float S;
    public MatrixAddScalar(MatrixExpression a, float s)
    {
        E = a;
        S = s;
    }
    public override Single.matrix Evaluate()
    {
        var (e, sa) = E is MatrixScale Es ? (Es.E, Es.S) : (E, 1.0f);
        var a = e.Evaluate();
        var r = e is MatrixInput ? new Single.matrix(a.Rows, a.Cols) : a;
        Vml.LinearFrac(a.Length, a.Array, a.Array, sa, S, 0.0f, 1.0f, r.Array);
        return r;
    }
}
...
public class MatrixMultiply : MatrixExpression
{
    public readonly MatrixExpression Ea, Eb;
    public readonly float[]? R;
    public MatrixMultiply(MatrixExpression a, MatrixExpression b, float[]? reuse)
    {
        Ea = a;
        Eb = b;
        R = reuse;
    ...
    public override Single.matrix Evaluate()
    {
        var (ea, ta, sa) = Ea is MatrixScale msa ? (msa.E is MatrixTranspose mta ? (mta.E, Trans.Yes, msa.S) : (msa.E, Trans.No, msa.S))
                         : Ea is MatrixTranspose mta2 ? (mta2.E, Trans.Yes, 1.0f)
                         : (Ea, Trans.No, 1.0f);
        var (eb, tb, sb) = Eb is MatrixScale msb ? (msb.E is MatrixTranspose mtb ? (mtb.E, Trans.Yes, msb.S) : (msb.E, Trans.No, msb.S))
                         : Eb is MatrixTranspose mtb2 ? (mtb2.E, Trans.Yes, 1.0f)
                         : (Eb, Trans.No, 1.0f);
        var a = ea.Evaluate();
        var b = eb.Evaluate();
        var k = ta == Trans.Yes ? a.Rows : a.Cols;
        if (k != (tb == Trans.Yes ? b.Cols : b.Rows)) ThrowHelper.ThrowIncorrectDimensionsForOperation();
        var r = R is null ? new Single.matrix(ta == Trans.Yes ? a.Cols : a.Rows, tb == Trans.Yes ? b.Rows : b.Cols)
                          : new Single.matrix(ta == Trans.Yes ? a.Cols : a.Rows, tb == Trans.Yes ? b.Rows : b.Cols, R);
        Blas.gemm(Layout.ColMajor, ta, tb, r.Rows, r.Cols, k, sa * sb, a.Array, a.Rows, b.Array, b.Rows, 0.0f, r.Array, r.Rows);
        if (ea is not MatrixInput) a.Dispose();
        if (eb is not MatrixInput) b.Dispose();
        return r;
    }
...
{
    readonly float b;
    public MatrixPowx(MatrixExpression a, float b) : base(a) => this.b = b;
    protected override void Evaluate(Single.matrix a, Single.matrix r)
...
{
    readonly float b;
    public MatrixMaxScalar(MatrixExpression a, float b) : base(a) => this.b = b;
    protected override void Evaluate(Single.matrix a, Single.matrix r)
...
{
    readonly float b;
    public MatrixMinScalar(MatrixExpression a, float b) : base(a) => this.b = b;
    protected override void Evaluate(Single.matrix a, Single.matrix r)
...
public class MatrixCopySign : MatrixBinary
{
    ...
    protected override void Evaluate(Single.matrix a, Single.matrix b, Single.matrix r)
...
{
    readonly float Scalea, Shifta, Scaleb, Shiftb;
    public MatrixLinearFrac(MatrixExpression a, MatrixExpression b, float scalea, float shifta, float scaleb, float shiftb) : base(a, b)
    {
        Scalea = scalea;
        Shifta = shifta;
        Scaleb = scaleb;
...
public class MatrixInverse : MatrixExpression
{
    ...
    public override Single.matrix Evaluate()
    {
        ...
        if (E is MatrixInput) a = Single.Matrix.Copy(a);
