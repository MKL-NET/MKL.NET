...
try
{
    ...
    GetPackage intelmkl.redist.win-x64 2021.4.0.640
    ...
    GetPackage intelmkl.redist.win-x86 2021.4.0.640
    ...
    GetPackage intelopenmp.redist.win 2021.4.0.3556
    ...
    GetPackage inteltbb.redist.win 2021.4.0.622
    ...
    dotnet pack MKL.NET.win-x64 -o packages -p:Version=2021.4.0.640
    dotnet pack MKL.NET.win-x86 -o packages -p:Version=2021.4.0.640
