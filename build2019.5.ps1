...
try
{
    ...
    GetPackage intelmkl.redist.win-x64 2019.5.281
    ...
    GetPackage intelmkl.redist.win-x86 2019.5.281
    ...
    GetPackage intelopenmp.redist.win 2019.5.281
    ...
    GetPackage inteltbb.redist.win 2019.8.281
    ...
    GetPackage intelmkl.devel.linux-x64 2019.5.281
    ...
    GetPackage intelmkl.devel.linux-x86 2019.5.281
    ...
    GetPackage intelopenmp.devel.linux 2019.5.281
    ...
    GetPackage inteltbb.devel.linux 2019.8.281
    ...
    GetPackage intelmkl.devel.osx-x64 2019.5.281
    ...
    GetPackage intelopenmp.devel.osx 2019.5.281
    ...
    GetPackage inteltbb.devel.osx 2019.8.281
    ...
    dotnet pack MKL.NET.win-x64 -o packages -p:Version=2019.5.281
    dotnet pack MKL.NET.win-x86 -o packages -p:Version=2019.5.281
    dotnet pack MKL.NET.linux-x64 -o packages -p:Version=2019.5.281
    dotnet pack MKL.NET.linux-x86 -o packages -p:Version=2019.5.281
    dotnet pack MKL.NET.osx-x64 -o packages -p:Version=2019.5.281
}
