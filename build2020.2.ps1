...
try
{
    ...
    GetPackage intelmkl.redist.win-x64 2020.2.254
    ...
    GetPackage intelmkl.redist.win-x86 2020.2.254
    ...
    GetPackage intelmkl.devel.linux-x64 2020.2.254
    ...
    GetPackage intelmkl.devel.linux-x86 2020.2.254
    ...
    GetPackage intelmkl.devel.osx-x64 2020.2.258
    ...
    dotnet pack MKL.NET.win-x64 -o packages -p:Version=2020.2.254
    dotnet pack MKL.NET.win-x86 -o packages -p:Version=2020.2.254
    dotnet pack MKL.NET.linux-x64 -o packages -p:Version=2020.2.254
    dotnet pack MKL.NET.linux-x86 -o packages -p:Version=2020.2.254
    dotnet pack MKL.NET.osx-x64 -o packages -p:Version=2020.2.258
}
